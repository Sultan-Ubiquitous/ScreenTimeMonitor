...
dbname = 'postgres'
user = 'postgres.liyribwgtjabyyubhxpo'
password = 'ScreenMonitor@123'
port = 6543
...
signal.signal(signal.SIGHUP, signal_handler)  # Handle hangup signals
signal.signal(signal.SIGTSTP, signal_handler)  # Handle terminal stop signals
